    ...
    public class ExerciseDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Exercise>().HasData(
                new Exercise { ExerciseId = 1, Name = "Chin Ups", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=chin+ups+demo" },
                new Exercise { ExerciseId = 2, Name = "Behind Neck Pull Ups", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Behind+The+Neck+Pull+Up" },
                new Exercise { ExerciseId = 3, Name = "Barbell Curls", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Barbell+Biceps+Curl+-+Demo" },
                new Exercise { ExerciseId = 4, Name = "Behind Head Overhead Barbell Press", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Behind+the+Neck+Overhead+Press+demo" },
                new Exercise { ExerciseId = 5, Name = "Landmine Twist Push", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Landmine+twist+press" },
                new Exercise { ExerciseId = 6, Name = "Landmine Pull Rotation", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Power%3A+Landmine+Pull+to+Press" },
                new Exercise { ExerciseId = 7, Name = "Landmine Rotations", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Landmine+Rotation" },
                new Exercise { ExerciseId = 8, Name = "Overhead Squats", ExerciseType = "Core", WorkoutType = "LowerBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=OVERHEAD+SQUAT" },
                new Exercise { ExerciseId = 9, Name = "Front Lunges", ExerciseType = "Core", WorkoutType = "LowerBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=How+To+Do+A+Forward+Lunge" },
                new Exercise { ExerciseId = 10, Name = "Side Lunges", ExerciseType = "Core", WorkoutType = "LowerBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=Side+Lunges+Demonstration" },
                ...
                new Exercise { ExerciseId = 21, Name = "Bench Press", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=bench+press" },
                new Exercise { ExerciseId = 22, Name = "Overhead Press", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=How+To+Perfect+The+Overhead+Press" },
                new Exercise { ExerciseId = 23, Name = "Pull-Ups", ExerciseType = "Core", WorkoutType = "UpperBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=pull+up+demo" },
                ...
                new Exercise { ExerciseId = 30, Name = "Squat", ExerciseType = "Core", WorkoutType = "LowerBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=The+Back+Squat" },
                new Exercise { ExerciseId = 31, Name = "Deadlift", ExerciseType = "Core", WorkoutType = "LowerBodyStrength", VideoUrl = "https://www.youtube.com/results?search_query=The+Deadlift%3A+CrossFit+Foundational+Movement" },
